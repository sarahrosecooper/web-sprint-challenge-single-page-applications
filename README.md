...
It is used to similarly to Route to match the path name exactly.
1. How would you explain form validation to someone who has never programmed before?
Form validation is used to ensure that a form has been filled out correctly to the creator's requirements.
1. In 1-2 sentences, define end to end testing.
End to end testing is used to test an application from beginning to end of the user experience and ensure that it is working properly.
